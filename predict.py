...
for an_instance in input_list:
    x_sent, x_position = subword_id_getter(an_instance["sent_1"], an_instance["e1_start_char"])
    y_sent, y_position = subword_id_getter(an_instance["sent_2"], an_instance["e2_start_char"])
